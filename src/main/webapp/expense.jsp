		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<span class="col-xs-4"><input type="submit" class="btn btn-block btn-sm btn-danger" onclick='<%request.setAttribute("expenseid", expenselist.get(i).getID()); %>' value="Delete" /></span>
					</td>
					</form>
